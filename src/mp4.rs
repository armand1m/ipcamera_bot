...
pub struct Opts {
    ...
    pub(crate) initial_timestamp: retina::client::InitialTimestampPolicy,
    ...
    #[arg(default_value_t, long)]
    pub(crate) teardown: retina::client::TeardownPolicy,
    ...
    #[arg(default_value_t, long)]
    pub(crate) transport: retina::client::Transport,
...
pub async fn run(opts: Opts) -> Result<(), Error> {
    ...
    let creds = creds(opts.src.username.clone(), opts.src.password.clone());
